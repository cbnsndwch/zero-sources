...
export const MSG_LIVECHAT_TRANSFER_HISTORY_FALLBACK =
...
export const MSG_OMNICHANNEL_PRIORITY_CHANGE_HISTORY =
    'OMNICHANNEL_PRIORITY_CHANGE_HISTORY';
export const MSG_OMNICHANNEL_SLA_CHANGE_HISTORY =
    'OMNICHANNEL_SLA_CHANGE_HISTORY';
export const MSG_OMNICHANNEL_PLACED_CHAT_ON_HOLD =
    'OMNICHANNEL_PLACED_CHAT_ON_HOLD';
export const MSG_OMNICHANNEL_ON_HOLD_CHAT_RESUMED =
...
export type UserRoomChangeMessageType =
    (typeof USER_ROOM_CHANGE_MESSAGE_TYPES)[number];
...
export type MessageChangeMessageType =
    (typeof MESSAGE_CHANGE_MESSAGE_TYPES)[number];
