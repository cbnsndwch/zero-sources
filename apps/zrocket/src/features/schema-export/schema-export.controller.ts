...
export class SchemaExportController {
    ...
    @ApiOperation({
        ...
        description: 'Returns the complete Zero schema in a format that can be consumed by the MongoDB source server'
    })
    ...
    @ApiOperation({
        ...
        description: 'Returns the MongoDB collection to Zero table mappings for the source server'
    })
    ...
    @ApiOperation({
        ...
        description: 'Returns both schema and table mappings in a single response'
    })
    ...
    @ApiOperation({
        ...
        description: 'Returns configuration files and settings for the MongoDB source server'
    })
