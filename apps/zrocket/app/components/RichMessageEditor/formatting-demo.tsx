    ...
    <div className="p-4">
      ...
      <div className="mt-4 text-sm text-gray-600">
        ...
        <ul className="list-disc list-inside mt-2">
          {(['bold', 'italic', 'underline', 'strikethrough'] as TextFormatType[]).map(format => (
            <li key={format}>
              <strong>{format}:</strong> {getFormattingShortcut(format)}
            </li>
          ))}
        </ul>
      </div>
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-gray-600">
        Note: Programmatic formatting buttons would require additional editor ref setup.
...
export { FormattingDemo, ProgrammaticFormattingExample, exampleFormattedOutput };