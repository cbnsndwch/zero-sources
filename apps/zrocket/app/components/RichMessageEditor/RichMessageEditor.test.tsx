...
describe('RichMessageEditor', () => {
  ...
  it('shows character count when maxLength is provided', () => {
    ...
    render(
      <RichMessageEditor onSendMessage={mockOnSendMessage} maxLength={100} />
    );
    ...
    const errorBoundary = screen.queryByText('Something went wrong with the message editor. Please refresh the page.');
