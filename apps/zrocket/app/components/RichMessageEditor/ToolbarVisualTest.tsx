        ...
        <div className="max-w-4xl mx-auto p-8 space-y-6">
            ...
            <div className="space-y-4">
                <div className="p-4 border rounded-lg">
                    <h3 className="font-semibold mb-2">Formatting Toolbar Test</h3>
                    <p className="text-sm text-muted-foreground mb-3">
                        Try clicking the toolbar buttons or use keyboard shortcuts:
                    </p>
                    <ul className="text-sm text-muted-foreground mb-4 space-y-1">
                        <li>• <strong>Bold:</strong> Click B button or Ctrl+B</li>
                        <li>• <strong>Italic:</strong> Click I button or Ctrl+I</li>
                        <li>• <strong>Underline:</strong> Click U button or Ctrl+U</li>
                        <li>• <strong>Strikethrough:</strong> Click S button or Ctrl+Shift+S</li>
                    </ul>
                ...
                {messages.length > 0 && (
                    <div className="p-4 border rounded-lg bg-muted/50">
                        <h3 className="font-semibold mb-2">Sent Messages ({messages.length})</h3>
                        <div className="space-y-2 max-h-60 overflow-y-auto">
                            {messages.map((message, index) => (
                                <div key={index} className="p-2 bg-background rounded text-xs">
                                    <details>
                                        <summary className="cursor-pointer font-medium">
                                            Message {index + 1} - Click to see SerializedEditorState
                                        </summary>
            ...
            <div className="text-center text-sm text-muted-foreground">
                <p>
                    ✅ If you can see formatting toolbar buttons (B, I, U, S) above the editor,
