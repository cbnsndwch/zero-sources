---
title: 'chatById variable'
---

[Home](./index.md) &gt; [@cbnsndwch/zrocket-contracts](./zrocket-contracts.md) &gt; [chatById](./zrocket-contracts.chatbyid.md)
...
```typescript
chatById: _rocicorp_zero.SyncedQuery<
    'chatById',
    JwtPayload,
    true,
    [string],
...
\*\*Client-side\*\*: Returns the chat with all messages if found \*\*Server-side\*\*: Returns the chat only if user is a member (implemented in get-queries endpoint)
