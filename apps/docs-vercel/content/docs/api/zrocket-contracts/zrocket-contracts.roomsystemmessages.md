---
title: 'roomSystemMessages variable'
---

[Home](./index.md) &gt; [@cbnsndwch/zrocket-contracts](./zrocket-contracts.md) &gt; [roomSystemMessages](./zrocket-contracts.roomsystemmessages.md)

## roomSystemMessages variable
...
```typescript
roomSystemMessages: _rocicorp_zero.SyncedQuery<
    'roomSystemMessages',
    JwtPayload,
    true,
...
\*\*Client-side\*\*: Returns system messages ordered by creation time (newest first) \*\*Server-side\*\*: Filters system messages based on room access permissions: - Public channels: accessible to all authenticated users - Private groups/chats: accessible only to room members
