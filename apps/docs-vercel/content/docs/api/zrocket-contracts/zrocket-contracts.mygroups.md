---
title: 'myGroups variable'
---

[Home](./index.md) &gt; [@cbnsndwch/zrocket-contracts](./zrocket-contracts.md) &gt; [myGroups](./zrocket-contracts.mygroups.md)
...
```typescript
myGroups: _rocicorp_zero.SyncedQuery<
    'myGroups',
    JwtPayload,
    true,
    [],
...
\*\*Client-side\*\*: Returns all groups ordered by most recent message \*\*Server-side\*\*: Filters to only groups where user is a member (implemented in get-queries endpoint)
