...
<Callout type="success">
    **Thank you!** Every contribution, no matter how small, helps make
    zero-sources better for everyone.
</Callout>
...
- [ ] Follow the [style guide](/docs/contributing/style-guide)
- [ ] Use provided [templates](https://github.com/cbnsndwch/zero-sources/tree/main/apps/docs/templates) for new pages
...
<Callout>Custom component in JSX</Callout>
