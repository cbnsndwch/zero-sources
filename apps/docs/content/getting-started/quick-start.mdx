...
- Zero Sources installed (see [Installation](/getting-started/installation))
...
Now that you have a basic change source working:

- Learn about [Core Concepts](/getting-started/concepts)
- Explore [Advanced Configuration](/libraries/zero-source-mongodb/configuration)
- Try [Discriminated Unions](/libraries/zero-source-mongodb/discriminated-unions)
- Deploy with [Docker](/guides/docker-deployment)
