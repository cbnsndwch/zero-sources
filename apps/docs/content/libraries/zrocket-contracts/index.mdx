...
The `zrocket-contracts` library contains the shared contracts between the ZRocket demo application's frontend and backend, including Zero schemas, TypeScript types, and validation logic.
...
- [ZRocket Demo Documentation](/demos/zrocket)
- [API Reference](./api)
