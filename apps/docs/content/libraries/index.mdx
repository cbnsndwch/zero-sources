...
Zero Sources provides a collection of TypeScript libraries for building real-time change source implementations. Each library is designed to be composable, reusable, and type-safe.

## Core Libraries

<Cards>
  <Card title="zero-contracts" href="/libraries/zero-contracts" icon="file-contract">
    Zero protocol contracts and TypeScript types
  </Card>
  <Card title="zero-source-mongodb" href="/libraries/zero-source-mongodb" icon="database">
    MongoDB change streaming to Zero protocol
  </Card>
  <Card title="zero-nest-mongoose" href="/libraries/zero-nest-mongoose" icon="puzzle">
...
<Cards>
  <Card title="zero-watermark-zqlite" href="/libraries/zero-watermark-zqlite" icon="hard-drive">
    SQLite-based watermark storage
  </Card>
  <Card title="zero-watermark-nats-kv" href="/libraries/zero-watermark-nats-kv" icon="network">
...
<Cards>
  <Card title="synced-queries" href="/libraries/synced-queries" icon="refresh">
    Synced query utilities and helpers
  </Card>
  <Card title="zrocket-contracts" href="/libraries/zrocket-contracts" icon="rocket">
...
- Check out [demos](/demos) using these libraries
- Read [architecture](/architecture) documentation
