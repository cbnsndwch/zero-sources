...
description: Build your own change source implementation
---

# Custom Change Source Implementation
...
const { Records } = await streams.getRecords({
...
- Study the [MongoDB implementation](/change-sources/mongodb-server)
- Review the [Change Source Protocol](/architecture/change-source-protocol)
- Implement your custom change source
