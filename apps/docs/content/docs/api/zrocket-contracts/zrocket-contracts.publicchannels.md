---
title: 'publicChannels variable'
---

[Home](./index.md) &gt; [@cbnsndwch/zrocket-contracts](./zrocket-contracts.md) &gt; [publicChannels](./zrocket-contracts.publicchannels.md)

## publicChannels variable
...
```typescript
publicChannels: _rocicorp_zero.SyncedQuery<
    'publicChannels',
    unknown,
    false,
    [],
...
\*\*Client-side\*\*: Returns all public channels ordered by name \*\*Server-side\*\*: Returns all public channels (no permission filtering needed)
