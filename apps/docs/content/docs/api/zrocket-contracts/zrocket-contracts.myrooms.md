---
title: 'myRooms variable'
---

[Home](./index.md) &gt; [@cbnsndwch/zrocket-contracts](./zrocket-contracts.md) &gt; [myRooms](./zrocket-contracts.myrooms.md)
...
```typescript
myRooms: _rocicorp_zero.SyncedQuery<
    'myRooms',
    JwtPayload,
    true,
    [],
...
\*\*Note\*\*: This query currently returns only chats. It is an alias for [myChats](./zrocket-contracts.mychats.md)<!-- -->. To retrieve both chats and groups, use [myChats](./zrocket-contracts.mychats.md) and [myGroups](./zrocket-contracts.mygroups.md) separately.

\*\*Client-side\*\*: Returns chats ordered by most recent message \*\*Server-side\*\*: Filters to only chats where user is a member (implemented in get-queries endpoint)
