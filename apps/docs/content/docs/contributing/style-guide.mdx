...
<Callout type="info">
    **Quick Reference**: When in doubt, follow patterns in existing
    documentation and prioritize clarity over strict rules.
</Callout>
...
```markdown
This is also called a _discriminated union_.
```
...
<Callout type="info">Use for general information or tips.</Callout>

<Callout type="warning">Use for important warnings or cautions.</Callout>

<Callout type="error">Use for critical errors or deprecated features.</Callout>

<Callout type="success">Use for confirmations or achievements.</Callout>
...
```markdown
A _discriminated union_ (also called a tagged union) allows...
```
...
<Callout type="info">**Prerequisites**: Node.js v22+ and pnpm v8+</Callout>
...
<Callout type="success">You've created your first Zero schema!</Callout>
````
...
<Callout type="tip">
    **Remember**: Clarity matters more than strict rule-following. If breaking a
    rule makes content clearer, do it!
</Callout>
