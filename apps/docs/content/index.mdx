...
description: Comprehensive documentation for Zero Sources - MongoDB-to-Zero change streaming infrastructure
icon: home
---

# Welcome to Zero Sources
...
<Cards>
  ...
  <Card title="Concepts" href="/getting-started/concepts" icon="book">
    Understand core concepts and architecture
  </Card>
  <Card title="Libraries" href="/libraries" icon="package">
...
- [Zero Source MongoDB](/libraries/zero-source-mongodb)
- [Watermark System](/architecture/watermark-system)
...
Ready to get started? Check out our [installation guide](/getting-started/installation) or dive into the [quick start tutorial](/getting-started/quick-start).
