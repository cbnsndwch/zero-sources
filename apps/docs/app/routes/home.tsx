            ...
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <div className="mb-16 max-w-4xl">
                    ...
                    <p className="mb-8 text-xl text-muted-foreground sm:text-2xl">
                        Utilities and custom change sources for Rocicorp Zero
                    </p>
                ...
                <div className="grid w-full max-w-6xl gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="rounded-lg border border-border bg-card p-6 text-left">
                        ...
                        <p className="text-muted-foreground">
                            NATS KV and ZQLite watermark storage for reliable
                            change streaming
                        </p>
                    </div>
                    ...
                    <div className="rounded-lg border border-border bg-card p-6 text-left">
                        ...
                        <p className="text-muted-foreground">
                            WebSocket-based streaming infrastructure for live
                    ...
                    <div className="rounded-lg border border-border bg-card p-6 text-left">
                        ...
                        <p className="text-muted-foreground">
                            Full-stack example apps showcasing Zero capabilities
                            and best practices
                        </p>
                    </div>
                </div>
