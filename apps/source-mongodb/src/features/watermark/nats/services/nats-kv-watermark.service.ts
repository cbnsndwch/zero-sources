...
import { type LexiVersion, versionFromLexi, versionToLexi } from '../../../zero/utils/lexi-version.js';

import type { IWatermarkService } from '../../contracts.js';

import { TOKEN_NATS_KV_BUCKET } from '../providers/nats-kv-bucket.provider.js';
...
export class NatsKvWatermarkService implements IWatermarkService {
    ...
    constructor(@Inject(TOKEN_NATS_KV_BUCKET) kv: KV) {
        this.#kv = kv;
    }
