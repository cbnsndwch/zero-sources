...
import { ROOM_TYPES } from '../contracts/rooms/index.js';
import { SYSTEM_MESSAGE_TYPES } from '../contracts/messages/index.js';
...
export const roomRelationships = relationships(room, ({ many }) => ({
    // members: many(
    //     {
    //         sourceField: ['id'],
